...
public class NewOrder {
	...
	private double m_percentOffset = Double.MAX_VALUE; // for Relative orders;
														// specify the decimal,
														// e.g. .04 not 4
	...
	private double m_trailingPercent = Double.MAX_VALUE; // for Trailing Stop
															// orders; specify
															// the percentage,
															// e.g. 3, not .03
	private double m_trailStopPrice = Double.MAX_VALUE; // stop price for
	...
	// volatility orders
	private double m_volatility = Double.MAX_VALUE; // enter percentage not
													// decimal, e.g. 2 not .02
	...
	private String m_hedgeParam; // beta value for beta hedge (in range 0-1),
	...
	private final ArrayList<OrderComboLeg> m_orderComboLegs = new ArrayList<OrderComboLeg>(); // array
																								// of
																								// leg
																								// prices
	...
	private boolean m_transmit = true; // if false, order will be sent to TWS
										// but not transmited to server
	...
	// private int m_shortSaleSlot; // 1 if you hold the shares, 2 if they will
	// be delivered from elsewhere. Only for Action="SSHORT
	...
	// private String m_clearingIntent; // "" (Default), "IB", "Away", "PTA"
	// (PostTrade)
	// private int m_auctionStrategy; // 1=AUCTION_MATCH, 2=AUCTION_IMPROVEMENT,
	// 3=AUCTION_TRANSPARENT // need type for this. ps
	...
	public static <T> void fill(List<T> list1, List<T> list2) {
		list1.clear();
